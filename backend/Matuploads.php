    ...
    if($year == "1" || $year == "2" || $year == "3") {
        if($semestermat == "1" || $semestermat == "2" || $semestermat == "3" || $semestermat == "4" || $semestermat == "5" || $semestermat == "6") {
            if($section == "A" || $section == "B") {
                ...
                $destination = $path."/backend/Uploads/Materials/".$year." Year/".$semestermat." Semester/".$section." Section/";
                echo $destination;
                $destinationFile = $path."/backend/Uploads/Materials/".$year." Year/".$semestermat." Semester/".$section." Section/".$filename;
                //echo "\n".$destination;
                ...
                elseif($_FILES['myfile']['size'] > 20000000) {
                  ...
                  if(!file_exists($destinationFile)) {
                      $isUploaded = move_uploaded_file($file, $destinationFile);
                    if($isUploaded) {
                        $query = "INSERT INTO Materials (name,year, semester,section,size,downloads,filepath) VALUES ('$filename',$year,$semestermat,'$section','$size',0,'$destination')";
