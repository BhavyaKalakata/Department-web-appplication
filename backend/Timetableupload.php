    ...
    if($year == "1" || $year == "2" || $year == "3") {
        if($semester == "1" || $semester == "2" || $semester == "3" || $semester == "4" || $semester == "5" || $semester == "6") {
            if($section == "A" || $section == "B") {
                ...
                $destination = $path."/backend/Uploads/Timetables/".$year." Year/".$semester." Semester/".$section." Section/";
                echo $destination;
                $destinationFile = $path."/backend/Uploads/Timetables/".$year." Year/".$semester." Semester/".$section." Section/".$filename;
                //echo "\n".$destination;
                ...
                elseif($_FILES['myfile']['size'] > 20000000) {
                  ...
                  if(!file_exists($destinationFile)) {
                    if(move_uploaded_file($file, $destinationFile)) {
                        $query = "INSERT INTO Timetables (name,year, semester,section,size,downloads,filepath) VALUES ('$filename',$year,$semester,'$section','$size',0,'$destination')";
