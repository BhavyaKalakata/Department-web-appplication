  ...
  //   }
    ...
    if($year == "1" || $year == "2") {
        if($semester == "1" || $semester == "2" || $semester == "3" || $semester == "4" || $semester == "5" || $semester == "6") {
                ...
                $destination = $path."/backend/Uploads/Syllabus/".$year." Year/".$semester." Semester/";
                echo $destination;
                $destinationFile = $path."/backend/Uploads/Syllabus/".$year." Year/".$semester." Semester/".$filename;
                //echo "\n".$destination;
                ...
                elseif($_FILES['myfile']['size'] > 20000000) {
                  ...
                  if(!file_exists($destinationFile)) {
                    if(move_uploaded_file($file, $destinationFile)) {
                        $query = "INSERT INTO Syllabus (name,year, semester,section,size,downloads,filepath) VALUES ('$filename',$year,$semester,'$section','$size',0,'$destination')";
